...
export default function Layout({ children }) {
      ...
      <div className="bg-highlight w-screen h-screen flex items-center">
        <div className="w-full flex items-center justify-center">
          <button
            ...
            className="bg-white p-2 px-4 rounded-lg flex gap-4"
          >
  ...
  return (
    <div className="bg-highlight min-h-screen">
      <div className="block flex items-center justify-between p-4 md:hidden">
        <button
          onClick={() => {
            setShowNav(true);
          }}
      ...
      <div className="bg-highlight flex">
        <Nav show={showNav} />
        <div className="bg-white flex-grow m-2 rounded-lg p-4 md:ml-0">
          {children}
        </div>
      </div>
    </div>
